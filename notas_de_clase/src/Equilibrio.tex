...
\begin{figure}[H]
     \centering
     \subfloat[Fuerzas en $y$]{\includegraphics[width=2.8 in]{Eqy.pdf}\label{EQy}}
     \hspace{0.5cm}
     \subfloat[Fuerzas en $z$]{\includegraphics[width=2.8 in]{Eqz.pdf}\label{EQz}}
...
\begin{figure}[H]
	\centering
		\subfloat [Solución fundamental ]{ \includegraphics[width=2.6in]{Ejer4_15_1.pdf}\label{cargaP_a}}
		\hspace{1.0cm}
		\subfloat [Estructuras y cable]{ \includegraphics[width=2.6in]{Ejer4_15_2.pdf}\label{cargaP_b}}		
	%\caption{Estructuras sobre la superficie}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=7.0cm]{Ejer4_19.pdf} 	
...
\end{enumerate}
%
%\item \label{punto22} La solución para un cilindro de radio interno $a$ y radio externo $b$ sometido a presiones internas y externas $p_a$ y $p_b$ respectivamente (ver \cref{cilindro}), está dado por:
%
%\begin{equation*}
%\sigma _{rr}  =  - \frac{{\left( {\frac{{{b^2}}}{{{r^2}}} - 1} \right)}}{{\left( {\frac{{{b^2}}}{{{a^2}}} - 1} \right)}}{p_a} - \frac{{\left( {1 - \frac{{{a^2}}}{{{r^2}}}} \right)}}{{\left( {1 - \frac{{{a^2}}}{{{b^2}}}} \right)}}{p_b} \hspace{1.5cm}
%\sigma _{\theta \theta } = \frac{{\left( {\frac{{{b^2}}}{{{r^2}}} + 1} \right)}}{{\left( {\frac{{{b^2}}}{{{a^2}}} - 1} \right)}}{p_a} - \frac{{\left( {1 + \frac{{{a^2}}}{{{r^2}}}} \right)}}{{\left( {1 - \frac{{{a^2}}}{{{b^2}}}} \right)}}{p_b} \hspace{1.5cm}
...
%\begin{figure}[H]
%\centering
%	\includegraphics[width=2.8 in]{cilindro.pdf}
%	\caption{Cilindro sometido a presión interna $p_a$ y presión externa $p_b$}
%	\label{cilindro}
%\end{figure}
% 	
%Usando la solución anterior, determinar las tensiones para un cilindro de radio interno $a$ y radio externo $2a$ sometido a una presión interna $q$ y apoyado sobre una superficie rígida en su cara externa, tal y como se muestra en la \cref{cilbase}
%%
%\begin{figure}[H]
%\centering
%	\includegraphics[width=3.3 in]{Cilbase.pdf}
%	\caption{Cilindro sometido a presión interna $q$ con superficie rígida en cara externa}
%	\label{cilbase}
%\end{figure}
...
\begin{figure}[H]
	\centering	
	\subfloat[Cuña de semi-ángulo interno $\alpha$ sometida a una carga vertical P.]{\includegraphics[width=3.0in]{figure_1b_T1.pdf}\label{CargaP}}	
	\hspace{1.5cm}
	\subfloat[Cuña de semi-ángulo interno $\alpha$ sometida a una carga vertical Q.]{\includegraphics[width=3.0in]{figure_1c_T1.pdf}\label{CargaQ}}
