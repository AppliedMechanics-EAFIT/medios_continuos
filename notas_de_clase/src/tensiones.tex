...
\begin{figure}[H]
	\centering
		...
		\hspace{0.5cm}
		\subfloat [Estado de tensión 2]{ \includegraphics[width=2.5in]{Estado2.pdf}\label{Estado2EjMohr}}		
...
\begin{figure}[H]
	\centering
		\subfloat [Estado de tensión 1]{ \includegraphics[width=2.5in]{Tensor1.pdf}\label{Tension1}}
		\hspace{0.5cm}
		\subfloat [Estado de tensión 2]{ \includegraphics[width=2.5in]{Tensor2.pdf}\label{Tension2}}		
...
\begin{figure}[H]
	\centering
		\subfloat [Estado de tensión 1]{ \includegraphics[width=2.5in]{Cubo1.pdf}\label{Cubo1}}
		\hspace{0.5cm}
		\subfloat [Estado de tensión 2]{ \includegraphics[width=2.5in]{Cubo2.pdf}\label{Cubo2}}		
...
\begin{figure}[H]
	\centering
		\subfloat [Estado de tensión 1]{ \includegraphics[width=2.5in]{Tens1Prin.pdf}\label{Tens1Prin}}
		\hspace{0.5cm}
		\subfloat [Estado de tensión 2]{ \includegraphics[width=2.5in]{Tens2Prin.pdf}\label{Tens2Prin}}		
...
\begin{figure}[H]
	\centering
		\subfloat [Estado de tensión 1]{ \includegraphics[width=2.5in]{Cubo1Prin.pdf}\label{Cubo1Prin}}
		\hspace{0.5cm}
		\subfloat [Estado de tensión 2]{ \includegraphics[width=2.5in]{Cubo2Prin.pdf}\label{Cubo2Prin}}		
...
\begin{figure}[H]
	\centering
		\subfloat [Circulo de Mohr]{ \includegraphics[width=2.5in]{TensorSup.pdf}\label{TensorSup}}
		\hspace{0.5cm}
		\subfloat [Cubo de tensiones]{ \includegraphics[width=2.5in]{CuboSup.pdf}\label{CuboSup}}		
...
\begin{figure}[H]
	\centering
		\subfloat []{ \includegraphics[width=2.5in]{punto.pdf}\label{punto}}		
...
\begin{figure}[H]
	\centering
		\subfloat []{ \includegraphics[width=2.5in]{cirmodif.pdf}\label{modif}}		
...
\begin{figure}[H]	
	\centering	
	\subfloat [Ensayo de compresi\'on simple]{ \includegraphics[width=2.5in]{Ejer3_11_1.pdf}\label{compresimple}}
	\hspace{10mm}
...
\begin{figure}[H]
	\centering
		\subfloat [Bloque macizo de arcilla extraido del muro estructural]{ \includegraphics[width=2.5in]{Ejer3_12_1.pdf}\label{bloque}}
		\hspace{0.5cm}
		\subfloat [Esfuerzos en cualquier punto del bloque $(kgf/cm^2)$.]{ \includegraphics[width=2.5in]{Ejer3_12_2.pdf}\label{esfuerzo}}		
	\caption{ }
	\label{TensSupPrin}
\end{figure}
%
...
\begin{figure}[H]
	\centering
		\subfloat [Bloque seccionado.]{ \includegraphics[width=2.5in]{Ejer3_12_3.pdf}\label{corte}}
		\hspace{1.0cm}
		\subfloat [Resistencia del pegamento.]{ \includegraphics[width=2.5in]{Ejer3_12_4.png}\label{curvas2}}		
	\caption{ }
\end{figure}
%
\begin{enumerate}
...
\begin{figure}[H]
	\centering
		\subfloat [Columna sometida a una tensi\'on de compresi\'on $\sigma_{yy}$.]{ \includegraphics[width=2.5in]{Ejer3_16_1.pdf}\label{Bloq_corte}}
		\hspace{2.0cm}
		\subfloat [Tensor de tensiones en cualquier punto al interior de la columna.]{ \includegraphics[width=2.5in]{Ejer3_16_2.pdf}\label{curvas}}		
	\label{ColComp}
...
\begin{figure}[H]
	\centering
		\subfloat [Viga sometida a carga distribuida $a$.]{ \includegraphics[width=2.5in]{Ejer3_17_1.pdf}\label{viga:empo}}
		\hspace{2.0cm}
...
\begin{figure}[H]
	\centering
		\subfloat []{ \includegraphics[width=2.2in]{Ejer3_20_1.pdf}\label{piramide}}
		\hspace{2.0cm}
		\subfloat []{ \includegraphics[width=2.2in]{Ejer3_20_2.pdf}\label{plano45}}		
	\caption{ }
\end{figure}
%
