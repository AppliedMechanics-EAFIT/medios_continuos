...
\begin{figure}[H]
\centering
\includegraphics[height=2.5 in]{rota_ejes.pdf}
...
\begin{figure}[H]	
	\centering	
	\subfloat [Ensayo de compresi\'on simple]{ \includegraphics[width=2.2in]{Ejer3_11_1.pdf}\label{compresimple}}
	\hspace{10mm}
	\subfloat [Sección en planta de lado $b$, ensayo confinado]{ \includegraphics[width=1.8in]{Ejer3_11_2.pdf}\label{compreconf}}
