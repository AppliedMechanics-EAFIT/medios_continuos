...
Eliminando $\sigma_{zz}$ se tiene que:
...
\begin{figure}[H]
	\centering
	\subfloat[Barra compresión]{\includegraphics[width=3.5cm]{Compresion.pdf}\label{compresion}}
	\hspace{0.5cm}
	\subfloat[Barra tracción]{\includegraphics[width=3.5cm]{Traccion.pdf}\label{traccion}}
		\hspace{0.5cm}
	\subfloat[Curvas de esfuerzo]{\includegraphics[width=5.0cm]{Esftime.pdf}\label{carga}}
